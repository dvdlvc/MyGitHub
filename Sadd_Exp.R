...
library('EQL') # library containing Edgeworth and saddlepoint density approximations
...
sigma2 <- 1
# higher order moments of order 3 and 4
rho3 <- 2 
rho4 <- 6 
mu <- 1 # mean of the asym approx
tail <- 3 # define a cut off for the tail---needed just for plotting purposes


# Approximations: functional forms 
n <- 10 # 
