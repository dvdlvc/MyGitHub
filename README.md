...
1- Sadd_Exp.R https://github.com/dvdlvc/MyGitHub/blob/Saddlepoint_MeasureTransportation/Sadd_Exp.R  generates the Figure 2 and Figure 3 available in the paper.
...
Both R files have been writteb by Davide La Vecchia, on May 2020 (last update).
